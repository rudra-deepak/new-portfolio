...
const SkillProgress = ({ name, level }) => (
  <div className="mb-4">
    <div className="flex justify-between items-center mb-1">
      ...
      <span className="text-yellow-400 text-xs font-bold font-mono">{level}%</span>
    </div>
...
const SkillCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:scale-[1.02] hover:border-yellow-500/30 hover:shadow-[0_20px_50px_rgba(255,42,42,0.1)] transition-all duration-500"
  >
...
const TechnicalSkills = () => {
  return (
    <section id="skills" className="bg-[#0a0a0a] pt-24 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-yellow-600/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-yellow-500/10 rounded-full blur-[120px] pointer-events-none" />
