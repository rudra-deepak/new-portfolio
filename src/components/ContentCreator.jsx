...
const CreatorCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:scale-[1.02] hover:border-yellow-500/30 hover:shadow-[0_20px_50px_rgba(255,42,42,0.15)] transition-all duration-500 group flex flex-col justify-between"
  >
    {/* <div>
      <div className="flex justify-between items-start mb-6">
        <span className="text-4xl p-3 bg-white/5 rounded-2xl group-hover:bg-[#36013F]/10 group-hover:scale-110 transition-all duration-300">
          {category.icon}
        </span>
      ...
      <h3 className="text-white text-xl md:text-2xl font-black mb-3 tracking-tight group-hover:text-[#36013F] transition-colors">
        {category.title}
      </h3>
...
const ContentCreator = () => {
  return (
    <section id="creator" className="bg-[#0a0a0a] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-yellow-600/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="mt-16 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-8 py-4 rounded-full bg-[#36013F] text-black font-bold text-lg hover:bg-yellow-600 hover:shadow-[0_0_30px_rgba(255,255,0,0.4)] transition-all duration-500 group"
          >
