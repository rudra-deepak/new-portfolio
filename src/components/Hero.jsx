...
import heroVideo from '../assets/hero video/Rudra-hero.mp4';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50 mix-blend-difference">
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="text-white/60 hover:text-[#36013F] transition-all duration-300 transform hover:scale-125"
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#36013F]" aria-label="Instagram">
          ...
          >
            {heroContent.greeting}, <br /> <span className="text-transparent [-webkit-text-stroke:1.5px_red]">{heroContent.titleHighlight}</span>
          </h1>
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#36013F] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(255,42,42,0.6)]">
            {!isPlaying || isMuted ? (
              // Play Icon
