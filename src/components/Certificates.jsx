...
const Certificates = () => {
  return (
    <section className="bg-[#36013F] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          ...
          >
            <svg className="w-5 h-5 text-[#36013F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
